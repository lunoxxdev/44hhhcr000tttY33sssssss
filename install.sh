...
###
BURIQ () {
    curl -sS https://raw.githubusercontent.com/lunoxxdev/d4l4nW3dUs/main/dalanPPQ > /root/tmp
...
# https://raw.githubusercontent.com/lunoxxdev/d4l4nW3dUs/main/dalanPPQ 
MYIP=$(curl -sS ipv4.icanhazip.com)
Name=$(curl -sS https://raw.githubusercontent.com/lunoxxdev/d4l4nW3dUs/main/dalanPPQ | grep $MYIP | awk '{print $2}')
...
PERMISSION () {
    MYIP=$(curl -sS ipv4.icanhazip.com)
    IZIN=$(curl -sS https://raw.githubusercontent.com/lunoxxdev/d4l4nW3dUs/main/dalanPPQ | awk '{print $4}' | grep $MYIP)
    if [ "$MYIP" = "$IZIN" ]; then
    Bloman
    else
...
sleep 2
clear
wget https://raw.githubusercontent.com/lunoxxdev/44hhhcr000tttY33sssssss/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "$green[INFO]$NC Install XRAY!"
sleep 2
clear
wget https://raw.githubusercontent.com/lunoxxdev/44hhhcr000tttY33sssssss/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
echo -e "$green[INFO]$NC Install SET-BR!"
wget https://raw.githubusercontent.com/lunoxxdev/44hhhcr000tttY33sssssss/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
echo -e "$green[INFO]$NC Install WEBSOCKET!"
wget https://raw.githubusercontent.com/lunoxxdev/44hhhcr000tttY33sssssss/main/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
wget https://raw.githubusercontent.com/lunoxxdev/44hhhcr000tttY33sssssss/main/websocket/nontls.sh && chmod +x nontls.sh && ./nontls.sh
clear
echo -e "$green[INFO]$NC Download Extra Menu"
sleep 2
wget https://raw.githubusercontent.com/lunoxxdev/44hhhcr000tttY33sssssss/main/update/update.sh && chmod +x update.sh && ./update.sh
rm -f update.sh
clear
ln -fs /usr/share/zoneinfo/Asia/Jakarta /etc/localtime
clear
...
echo ""  | tee -a log-install.txt
echo "   >>> Join Grub : Internet Gratis Hoax"  | tee -a log-install.txt
echo "   >>> Telegram : t.me/lunoxximpostor"  | tee -a log-install.txt
echo ""
echo ""
echo "------------------------------------------------------------"
echo ""
