...
data_ip="https://raw.githubusercontent.com/lunoxxdev/d4l4nW3dUs/main/dalanPPQ"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "\033[42m          Lunoxx Impostor          \033[0m"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    echo -e ""
    echo -e "            ${RED}PERMISSION DENIED !${NC}"
    echo -e "   \033[0;33mYour VPS${NC} $ipsaya \033[0;33mHas been Banned${NC}"
    echo -e "     \033[0;33mTertolak Mentah-Mentah Akawoakow${NC}"
    echo -e "             \033[0;33mContact Admin :${NC}"
    echo -e "      \033[0;36mTelegram${NC} t.me/lunoxximpostor"
    echo -e "      ${GREEN}Join Grub${NC} IGH Cok"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
...
Exp=$(curl -sS https://raw.githubusercontent.com/lunoxxdev/d4l4nW3dUs/main/dalanPPQ | grep $MYIP | awk '{print $3}')
fi
...
echo -e "  ${BLUE}• ${GREEN}Developer           ${NC}= Lunoxx Tunneling ${NC}"
echo -e "$COLOR1┌────────────────────────────────────────────────────────────┐${NC}"
